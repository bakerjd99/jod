NB.*locgrpSmoke00 t-- (locgrp) smoke tests.
NB.
...
cocurrent jodtestlocale 'AAAlocgrpSmoke00'
...
NB. check group word appears in (locgrp)
rc [ 'rc loctab'=: locgrp 1 pick grpwrds
(<1 pick grp '') e. ; 1{0{loctab

NB. check suite test appears in (locgrp)
rc [ 'rc loctab'=: locgrp 1 pick suitests
(<1 pick 3 grp '') e. ; 1{1{loctab
