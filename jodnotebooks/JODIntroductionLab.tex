...
j901/j64avx/windows/beta-s/commercial/www.jsoftware.com/2019-12-02T12:51:33
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{NB. used by this lab}
...
INFORMATION YOU CARE ABOUT DO NOT EXECUTE THE NEXT LAB STEP!}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{n+nv}{RemoveLabDictionaries\PYZus{}ijod\PYZus{}}\PY{o}{=:} \PY{n+nf}{3 : 0}
...
dictionaries}\label{remove-any-prior-lab-dictionaries}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{NB. close any dictionaries \PYZhy{} ignore errors}
...
dictionaries}{This step creates the (lab) and (labdev) dictionaries}}\label{this-step-creates-the-lab-and-labdev-dictionaries}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{NB. close any open dictionaries}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
+-+---------------------+---+-------------------------------------+
|1|dictionary created ->|lab|c:/users/john/j901-user/joddicts/lab/|
+-+---------------------+---+-------------------------------------+
+-+---------------------+------+----------------------------------------+
|1|dictionary created ->|labdev|c:/users/john/j901-user/joddicts/labdev/|
+-+---------------------+------+----------------------------------------+
+-+---+------+-----+------+------+----+---+--+---+---+-----+----+---+------+----------+--- {\ldots} 
|1|bci|bcidev|bitjd|bpcopy|bptest|docs|fct|fd|fit|gps|image|imex|jod|joddev|joddevload|jod {\ldots} 
+-+---+------+-----+------+------+----+---+--+---+---+-----+----+---+------+----------+--- {\ldots} 
...
cannot be changed by JOD verbs.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{c+c1}{NB. open read/write}
...
tell me what you did.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{NB. bad open request}
...
+-+-------------------------------------------------+
    ...
    \subsubsection{Online JOD documentation}\label{online-jod-documentation}
...
Macs.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{NB. display JOD documentation}
...
(\texttt{did}) (dictionary identification) verb lists the path.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{NB. reopen only (labdev) and (lab)}
...
each dictionary on the path.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{NB. did \PYZti{} 0   NB. handy idiom}
...
\end{figure}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{NB. objects beginning with \PYZsq{}ajod\PYZsq{} are the JOD classes.}
...
dictionaries on the path but you cannot change them in any way.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{NB. first path dictionary is the put dictionary}
         \PY{n+nv}{did} \PY{l+m+mi}{0}
\end{Verbatim}
...
(\texttt{toy}) dictionary and make it the put dictionary.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{NB. close open dictionaries}
         \PY{l+m+mi}{3} \PY{n+nv}{od} \PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZsq{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
+-+---------------------+---+-------------------------------------+
|1|dictionary created ->|toy|c:/users/john/j901-user/joddicts/toy/|
+-+---------------------+---+-------------------------------------+
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{c+c1}{NB. open toy, labdev and lab \PYZhy{} toy is the put dictionary}
...
First create some words to store.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{c+c1}{NB. create some words}
...
words have been erased before proceeding.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{c+c1}{NB. save words}
...
1 1 1 1 1 1 1 1 1
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{c+c1}{NB. get words}
...
word.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{c+c1}{NB. store short word descriptions}
...
+-+-------------------------------+---+
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{c+c1}{NB. get short explanations}
...
(\texttt{rc;value})
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{c+c1}{NB. loads (changestr) and (changestr) documentation into the current put dictionary}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{c+c1}{NB. show long documentation}
...
dyad:  clChanged =. clTargets changestr clStr
  ...
  +./ unew1 E. ucharsnew
    ...
    \subsubsection{More putting and getting}\label{more-putting-and-getting}

(\texttt{put}) and (\texttt{get}) are quite flexible and can store
entire locales. The locales can be named or numbered.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{c+c1}{NB. save the (ajodmake) locale/class in \PYZdq{}toy\PYZdq{}}
...
The main search command is (\texttt{dnl}) (dictionary name lists).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{c+c1}{NB. list all the words on the path beginning with \PYZsq{}du\PYZsq{}}
...
that begin with \texttt{\textquotesingle{}JOD\textquotesingle{}}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{c+c1}{NB. create some groups}
...
table displays JOD object codes.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{c+c1}{NB. JOD object codes}
...
Now look at some more (\texttt{dnl}) commands.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{c+c1}{NB. (group, option 1 \PYZhy{} match prefix) \PYZhy{} case matters}
...
create and modify groups and suites with the (\texttt{grp}) verb.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}27}]:} \PY{c+c1}{NB. create a group of words with names beginning with \PYZsq{}ch\PYZsq{}}
...
(\texttt{grp})}{You can list the contents of groups or suites with (grp)}}\label{you-can-list-the-contents-of-groups-or-suites-with-grp}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}28}]:} \PY{c+c1}{NB. list contents of testgroup group}
...
+-+----------+
    ...
    \subsubsection{Making groups and suites}\label{making-groups-and-suites}
...
generates scripts.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}29}]:} \PY{c+c1}{NB. left justify table verb}
         ...
         \PY{n+nv}{smoutput} \PY{l+m+mi}{0} \PY{n+nv}{mls}\PY{o}{\PYZam{}}\PY{o}{\PYZgt{}} \PY{o}{\PYZcb{}}\PY{o}{.} \PY{l+m+mi}{2} \PY{n+nv}{revo}\PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZsq{}}
...
executed with (\texttt{rm}).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}30}]:} \PY{c+c1}{NB. macro that generates all put dictionary groups}
...
dictionaries and using (\texttt{rm}) - run macro.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}31}]:} \PY{c+c1}{NB. fetch and execute silently \PYZhy{} will only display explicit code output}
         \PY{c+c1}{NB. 1 rm \PYZsq{}makeputgrps\PYZsq{}}
         
         \PY{c+c1}{NB. fetch and execute }
         \PY{n+nv}{rm} \PY{l+s}{\PYZsq{}}\PY{l+s}{m}\PY{l+s}{a}\PY{l+s}{k}\PY{l+s}{e}\PY{l+s}{p}\PY{l+s}{u}\PY{l+s}{t}\PY{l+s}{g}\PY{l+s}{r}\PY{l+s}{p}\PY{l+s}{s}\PY{l+s}{\PYZsq{}}
\end{Verbatim}
...
dictionaries. Only J scripts can be run however.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}32}]:} \PY{c+c1}{NB. store LaTeX (22) and HTML (23) texts}
...
The next step loads (\texttt{labdump.ijs}).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}33}]:} \PY{c+c1}{NB. insure correct path}
...
NB. end-of-JOD-dump-file regenerate cross references with:  0 globs\&> \}. revo '' 
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}34}]:} \PY{c+c1}{NB. update word references \PYZhy{} show first 5 messages}
...
references.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}35}]:} \PY{c+c1}{NB. analyze names}
...
+-+--------------------------------------------------------------------+
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}36}]:} \PY{c+c1}{NB. 0 is the word code \PYZhy{} stores global references}
...
+-+----------------------------+---+
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}37}]:} \PY{c+c1}{NB. global references for (dstat)}
...
references.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}38}]:} \PY{c+c1}{NB. insure toy is the put dictionary}
         \PY{n+nv}{od} \PY{o}{;}\PY{o}{:}\PY{l+s}{\PYZsq{}}\PY{l+s}{t}\PY{l+s}{o}\PY{l+s}{y}\PY{l+s}{ }\PY{l+s}{l}\PY{l+s}{a}\PY{l+s}{b}\PY{l+s}{d}\PY{l+s}{e}\PY{l+s}{v}\PY{l+s}{ }\PY{l+s}{l}\PY{l+s}{a}\PY{l+s}{b}\PY{l+s}{\PYZsq{}} \PY{o}{[} \PY{l+m+mi}{3} \PY{n+nv}{od} \PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZsq{}}
\end{Verbatim}
...
search mechanism is used for retrieving references.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}39}]:} \PY{c+c1}{NB. global references of words beginning with \PYZsq{}m\PYZsq{}}
...
call tree of a word.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}40}]:} \PY{c+c1}{NB. uses union of two words}
...
scripts are written to the put dictionary's script subdirectory.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}41}]:} \PY{c+c1}{NB. generate load script}
         \PY{n+nv}{mls} \PY{l+s}{\PYZsq{}}\PY{l+s}{s}\PY{l+s}{u}\PY{l+s}{n}\PY{l+s}{m}\PY{l+s}{o}\PY{l+s}{o}\PY{l+s}{n}\PY{l+s}{\PYZsq{}}   \PY{c+c1}{NB. sun/moon rise set}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
+-+--------------------+-------------------------------------------------------+
|1|load script saved ->|c:/users/john/j901-user/joddicts/toy/script/sunmoon.ijs|
+-+--------------------+-------------------------------------------------------+
...
\texttt{Public\_j\_} for the current user.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}42}]:} \PY{c+c1}{NB. load generated script}
...
JOD can also generate and load scripts without creating load scripts.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}43}]:} \PY{c+c1}{NB. load basic statistics group}
...
+-+-------------------+
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}44}]:} \PY{c+c1}{NB. load into arbitrary locales}
...
and JOD does as well. The (\texttt{packd}) verb backups up a database.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}45}]:} \PY{c+c1}{NB. save a backup of the current put dictionary}
...
backup number.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}46}]:} \PY{c+c1}{NB. list put dictionary backup files}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
0jgroups.ijf       22400 09-Dec-19 09:06:27
0jmacros.ijf      142208 09-Dec-19 09:06:24
0jsuites.ijf        6272 09-Dec-19 09:06:14
0jtests.ijf         6016 09-Dec-19 09:06:14
0juses.ijf         21120 09-Dec-19 09:06:33
0jwords.ijf       202560 09-Dec-19 09:06:47
...
the highest prefix.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}47}]:} \PY{c+c1}{NB. restore last backup}
...
objects from particular backups.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}48}]:} \PY{c+c1}{NB. open (toy) and create new backup}
...
+-+--+--+
+-+--------+--------+--------+--------+--------+-------+-------+-------+-------+-------+-- {\ldots} 
|1|DUMPMSG0|DUMPMSG1|DUMPMSG2|DUMPMSG3|DUMPMSG4|DUMPTAG|ERR0150|ERR0151|ERR0152|ERR0153|ER {\ldots} 
+-+--------+--------+--------+--------+--------+-------+-------+-------+-------+-------+-- {\ldots} 
...
selecting what you need.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}49}]:} \PY{c+c1}{NB. fetch all words from last backup}
         ...
         \PY{n+nv}{ed} \PY{l+m+mi}{5} \PY{o}{\PYZob{}}\PY{o}{.} \PY{n+nv}{ncv}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
\$\$\$edit\$\$\$c:/users/john/j901-user/temp/DUMPMSG0\_2.ijs
...
be used to backup, copy and merge dictionaries.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}50}]:} \PY{c+c1}{NB. dump all the words on the path as a single dump script.}
         \PY{n+nv}{toydump}\PY{o}{=:} \PY{n+nv}{showpass\PYZus{}ajod\PYZus{}} \PY{n+nv}{make} \PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZsq{}}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
+-+---------------------------+-------------------------------------------------+
|1|object(s) on path dumped ->|c:/users/john/j901-user/joddicts/toy/dump/toy.ijs|
+-+---------------------------+-------------------------------------------------+
...
path is changed. The dictionaries have been merged.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}51}]:} \PY{c+c1}{NB. new dictionary}
...
\end{verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}52}]:} \PY{c+c1}{NB. close any open dictionaries}
         \PY{l+m+mi}{3} \PY{n+nv}{od} \PY{l+s}{\PYZsq{}}\PY{l+s}{\PYZsq{}}
\end{Verbatim}
